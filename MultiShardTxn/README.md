...
| Constants | Symmetry | Invariant | Time | States | Depth | Error |
|------| ------|------|------|------|------|------|
| <ul><li>`Keys={k1, k2}`</li><li>`TxId={t1, t2}`</li><li> `Router={r1}`</li> <li> `MaxOpsPerTxn=3`</li> <li> `RC="local"`</li>  </ul>| `Symmetry` | `RepeatableReadIsolation` | ~10 min | 34,020,934 | 37 |  None |
