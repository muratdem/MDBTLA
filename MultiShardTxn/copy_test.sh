...
evg_cmd="/home/ubuntu/evergreen patch --large -p wiredtiger -t coverage-report-python,generate-coverage-report -v code-statistics -d 'coverage_pct=$cvg_pct path coverage' -f -y"
